...
public class SgfpService : ISgfpService
{
    ...
    public Sgfp MetaSgfp(Person person)
    {
        ...
        while (true)
        {
            ...
            {
                case "1":
                    Console.Write("Ingrese un concepto para la meta financiera: ");
                    string conceptoMeta = Console.ReadLine();

                    Console.Write("Ingrese la cantidad de ahorro para la meta: ");
                    decimal cantidadAhorroMeta = decimal.Parse(Console.ReadLine());

                    Console.Write("Ingrese un lapso de tiempo en el cual quiera que su meta se cumpla: ");
                ...
                case "2":
                    for (int i = 0; i < MontosMetas.Count; i++)
                    {
                        Console.WriteLine("\n=========== {0} ============", conceptosMetas[i]);
                        Console.WriteLine(
                            "Tu meta de ahorro para " + conceptosMetas[i] + " es de {0} pesos.",
                            MontosMetas[i]
                        );
                        Console.WriteLine(
